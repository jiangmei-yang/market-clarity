...
export const TOOL_CATALOG:ToolDefinition[]=[
  ...
  tool("route_quant_engine","选择研究方式","根据用户目标选择最简单、透明且当前可用的研究引擎；普通界面隐藏框架名称","quant","safe",["user_input","strategy_registry"],["研究目标","低频ETF策略","比较几种方法","自己找规律","机器学习实验","强化学习实验","选择引擎"]),
  tool("compile_quant_goal","生成量化研究方案","把目标、数据、频率、风险和模式转换为统一的非交易 DSL","quant","confirm",["user_input","strategy_registry"],["生成研究方案","创建量化任务","个人量化工作台"]),
...
export const DATA_SOURCE_REGISTRY=[
  ...
  {sourceId:"engine_registry",name:"量化引擎与适配器注册中心",available:true,scope:"包含可用性、版本、限制与许可证状态"},
