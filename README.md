...
当前验收：`55 passed`。除原有行情与持仓契约外，还覆盖智能研判驾驶舱、自然语言规则提取、理由分类、公告标题匹配的保守表达、市场证据快照、42% 演示仓位、损失情景、严重表达停止审查、修改后审查持久化、匿名测试 CSV、三条 FastAPI 决策接口、手机导航路径、统一股票分析容器、股票名单缓存和名称搜索容错。
